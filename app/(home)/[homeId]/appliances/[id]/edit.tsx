...
function EditApplianceScreen() {
  ...
  const handleDateSelect = (date: Date, type: 'purchase' | 'warranty') => {
    ...
    >
      ...
      >
        ...
        <View style={[styles.section, { backgroundColor: colors.surface }]}>
          ...
          <View style={styles.inputGroup}>
            ...
            >
              <Text style={[styles.dateButtonText, { color: colors.text }]}>
                {formData.warranty_expiration || 'Select warranty expiration'}
              </Text>
              <Ionicons name="calendar-outline" size={20} color={colors.primary} />
            </TouchableOpacity>
          </View>
      ...
      {showPurchaseDatePicker && (
        <DatePicker
          ...
          onSelect={(date) => handleDateSelect(date, 'purchase')}
      ...
      {showWarrantyDatePicker && (
        <DatePicker
          ...
          onSelect={(date) => handleDateSelect(date, 'warranty')}
          title="Select Warranty Expiration"
        />
      )}
    </KeyboardAvoidingView>
  );
