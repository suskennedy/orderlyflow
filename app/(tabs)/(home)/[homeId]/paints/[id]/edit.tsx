...
import { PaintsProvider, usePaints } from '../../../../../../lib/contexts/PaintsContext';
...
function EditPaintScreen() {
  const insets = useSafeAreaInsets();
  const { colors } = useTheme();
  const { paints, updatePaint } = usePaints();
...
export default function EditPaintScreenWrapper() {
  const params = useLocalSearchParams();
