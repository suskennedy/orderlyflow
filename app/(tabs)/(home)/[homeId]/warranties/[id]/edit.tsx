...
import { WarrantiesProvider, useWarranties } from '../../../../../../lib/contexts/WarrantiesContext';
...
function EditWarrantyScreen() {
  ...
  const { warranties, updateWarranty } = useWarranties();
...
export default function EditWarrantyScreenWrapper() {
  const params = useLocalSearchParams();
