    ...
    try {
      ...
      if (isCompleting) {
        ...
        taskUpdates = {
          ...
          is_active: completionData.is_active !== undefined ? completionData.is_active : false // Auto-deactivate unless specified
        };
        ...
        // For custom tasks, remove them completely instead of just deactivating
        if (currentTask.task_type === 'custom') {
          console.log('Custom task completed - will be removed completely:', currentTask.title);
          ...
          if (deleteError) {
            console.error('Error deleting custom task:', deleteError);
            throw deleteError;
          }
          ...
          if (removeEventsByTaskId) {
            await removeEventsByTaskId(taskId);
          }
          
          console.log('Custom task removed completely');
          return; // Exit early for custom tasks
        }
      } else {
        ...
        taskUpdates = {
          ...
          is_active: completionData.is_active !== undefined ? completionData.is_active : true // Reactivate unless specified
        };
      }
