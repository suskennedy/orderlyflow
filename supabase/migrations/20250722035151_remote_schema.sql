...
GRANT ALL ON TABLE "public"."infrastructure_locations" TO "anon";
GRANT ALL ON TABLE "public"."infrastructure_locations" TO "authenticated";
GRANT ALL ON TABLE "public"."infrastructure_locations" TO "service_role";



GRANT ALL ON TABLE "public"."light_fixtures" TO "anon";
GRANT ALL ON TABLE "public"."light_fixtures" TO "authenticated";
GRANT ALL ON TABLE "public"."light_fixtures" TO "service_role";



GRANT ALL ON TABLE "public"."paint_colors" TO "anon";
GRANT ALL ON TABLE "public"."paint_colors" TO "authenticated";
GRANT ALL ON TABLE "public"."paint_colors" TO "service_role";
...
GRANT ALL ON TABLE "public"."tiles" TO "anon";
GRANT ALL ON TABLE "public"."tiles" TO "authenticated";
GRANT ALL ON TABLE "public"."tiles" TO "service_role";
